...
Openstack REST API Performance Test Report:
...
Test Load Schema: <xsl:value-of select="$numThreads" />
Test Iterations Number: <xsl:value-of select="$numIterations" />
...
Top 5 Worst REST API Calls Response Time 90% Line:
...
Top 5 Worst Transactions Elapsed Time 90% Line:
...
---------------------------------------------------------------------------------------------------------------------------
| REST API Calls Response Time:
---------------------------------------------------------------------------------------------------------------------------
| REST API Call Label 			   | Count | Failures | Success Rate | Average Time | 90% Line Time | Min Time | Max Time |
---------------------------------------------------------------------------------------------------------------------------
...
<xsl:text>&#xa;</xsl:text>
---------------------------------------------------------------------------------------------------------------------------
| REST API Transactions Response Time:
---------------------------------------------------------------------------------------------------------------------------
| REST API Transaction Label		   | Count | Failures | Success Rate | Average Time | 90% Line Time | Min Time | Max Time |
---------------------------------------------------------------------------------------------------------------------------
    <xsl:for-each select="sample[contains(@lb, 'Trx') and not(@lb = preceding::*/@lb)]">
      <xsl:variable name="label" select="@lb" />
      <xsl:variable name="count" select="count(../*[@lb = current()/@lb])" />
      <xsl:variable name="failureCount" select="count(../*[@lb = current()/@lb][attribute::s='false'])" />
      <xsl:variable name="successCount" select="count(../*[@lb = current()/@lb][attribute::s='true'])" />
