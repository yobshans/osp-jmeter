...
<xsl:variable name="var_Monitor_Disk" select="'Monitor_Disk'" />
...
<body>
  <xsl:if test="$perfmonType = $var_Monitor_Disk">
    <xsl:call-template name="pageBody" >
      <xsl:with-param name="title-label" select="'Disk Utilization'" />
    </xsl:call-template>
  </xsl:if>
</body>
</html>
...
<xsl:template name="pageBody">
  ...
  <div class="body">
	...
	<th>Difference (Max)</th>
      ...
      <xsl:for-each select="/test/cpu[contains(@label, 'Disk') and not(@label = preceding::*/@label)]">
	...
	<tr valign="top">
	  ...
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$minBase" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$minCur" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$diff-min" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$aveBase" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$aveCur" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$diff-ave" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$maxBase" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$maxCur" /></xsl:call-template></td>
	  <td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$diff-max" /></xsl:call-template></td>
	</tr>
      </xsl:for-each>
    </table>
  </div>
...
<xsl:template name="display-disk">
