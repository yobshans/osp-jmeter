...
<xsl:template name="pageBody">
  ...
  <div class="body">
	...
	<td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$minTime div 1000" /></xsl:call-template></td>
	<td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$averageTime div 1000" /></xsl:call-template></td>
	<td align="center"><xsl:call-template name="display-disk"><xsl:with-param name="value" select="$maxTime div 1000" /></xsl:call-template></td>
      </tr>
    </xsl:for-each>
    </table>
  </div>
