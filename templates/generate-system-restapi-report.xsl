...
<xsl:template name="pageHeader">
  ...
  <xsl:if test="$perfMon='false' or $perfMon='False'">
    <div class="topnav">
      <a href="../index.html">Summary Report</a>
      <a class="active" href="api.html">REST API Calls Response Time Report</a>
      <a href="trx.html">Transactions Calls Response Time Report</a>
      <a href="ssh.html">SSH Commands Report</a>
    </div>
  </xsl:if>
...
<xsl:template name="pageBody">
  ...
  <div class="body">
    <h3>REST API Calls Response Time Report</h3>
    <hr size="1" />
    ...
    <xsl:for-each select="httpSample[contains(@lb, '.') and not(contains(@lb, 'setUp')) and not(contains(@lb, 'tearDown')) and not(@lb = preceding::*/@lb)]">
