...
<html>
<head>
<title>Openstack REST API Request/Response Data Report</title>
...
<xsl:template name="pageHeader">
  ...
  <div class="topnav">
    ...
    <a class="active" href="api.html">REST API Request/Response Data Report</a>
  </div>
...
<xsl:template name="pageBody">
  ...
  <div class="body">
    <h3 align="center">Openstack REST API Request/Response Data Report</h3>
    <hr size="1" />
	...
	<td align="center">
	  <div class="popup" onclick="popupChart('{$label}')">Click to view Data
	    <span class="popuptext"  id="{$label}" style="overflow-y:scroll; height:600px;">
...
<xsl:template name="pageFooter">
  ...
  <a id="jmeter" href="http://jmeter.apache.org/"><img alt="JMeter" src="../img/jmeter-logo.svg" height="50" width="200"></img></a>
  </div>
</xsl:template>
