...
<xsl:template name="pageBody">
  ...
  <div class="body">
    ...
    <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
      <tr valign="top">
	<th>Cluster Status Before Test</th>
	<th>Cluster Status After Action</th>
	<th>Cluster Status After Test</th>
      </tr>
      <tr valign="top">
	<td align="center">
	  <div class="popup" onclick="popupChart('stack-status-b4.txt')">Click to view Data
	       <span id="stack-status-b4.txt" class="popuptext"><object width="700px" height="500px" data="log/stack-start-test.txt"></object></span>
	  </div>
	</td>
	<td align="center">
	  <div class="popup" onclick="popupChart('stack-status-after-fail.txt')">Click to view Data
	       <span id="stack-status-after-fail.txt" class="popuptext"><object width="700px" height="500px" data="log/stack-status-after-fail.txt"></object></span>
	  </div>
	</td>
	<td align="center">
	  <div class="popup" onclick="popupChart('stack-status-a4.txt')">Click to view Data
	       <span id="stack-status-a4.txt" class="popuptext"><object width="700px" height="500px" data="log/stack-end-test.txt"></object></span>
	  </div>
	</td>
      </tr>
    </table>
