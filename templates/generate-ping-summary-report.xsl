...
<xsl:template name="pageBody">
  ...
  <div class="body">
    ...
    <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
      <tr valign="top">
	<th>SSH.PING.Instance Response Time Chart</th>
	<th>SSH.PING.Instance Transactions Per Second Chart</th>
      </tr>
      <tr valign="top">
	<td align="center">
	  <div class="popup" onclick="popupChart('SSH.PING.Instance.RT')"><img width="25px" height="25px" src="img/05.SSH.PING.Instance.png" />
	    <span class="popuptext"  id="SSH.PING.Instance.RT" ><img src="img/05.SSH.PING.Instance.png" /></span>
	  </div>
	</td>
	<td align="center">
	  <div class="popup" onclick="popupChart('SSH.PING.Instance.TPS')"><img width="25px" height="25px" src="img/05.SSH.PING.Instance.TPS.png" />
	    <span class="popuptext"  id="SSH.PING.Instance.TPS" ><img src="img/05.SSH.PING.Instance.TPS.png" /></span>
	  </div>
	</td>
      </tr>
    </table>
