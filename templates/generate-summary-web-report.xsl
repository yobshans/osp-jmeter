...
<html>
<head>
<title>Openstack Horizon Web Performance Test Report</title>
...
<xsl:template name="pageBody">
  ...
  <div class="body">
    <h3 align="center">Openstack Horizon Web Performance Test Report</h3>
    <hr size="1" />
  ...
  <h3 align="center">Stack structure</h3>
    <hr size="1" />
    <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
      <tr valign="top">
	<th>Node Type:</th>
